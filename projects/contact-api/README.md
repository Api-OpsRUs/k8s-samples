...
* Install Docker 
* Docker pull sidgs001/contact-api
* once successfully pulled run it as shown below 

```

docker pull sidgs001/contact-api:latest 
image=`docker images  sidgs001/contact-api:latest -q` 
...
Location header: http://localhost:8090/example/v1/contacts/1
```

### Retrieve a paginated list of contacts

```
http://localhost:8090/example/v1/contacts?page=0&size=10
